...
quiz: source/quiz_main.cpp source/log.cpp source/main.cpp
	...
	@g++ -Iinclude -c -g -o intermediates/ui.obj source/ui.cpp
	@g++ -Iinclude -c -g -o intermediates/game.obj source/game.cpp
...
exe: intermediates/quiz.obj intermediates/log.obj intermediates/main.obj
	@g++ -o output/quiz.exe intermediates/quiz.obj intermediates/log.obj intermediates/main.obj intermediates/functions.obj intermediates/ui.obj intermediates/game.obj
